(() => {
  ...
  // extensions/order-pdf-generator-ui/src/OrderStatusExtension.jsx
...
${errorInfo.componentStack}`);
  ...
  var OrderStatusExtension_default = reactExtension(
    "customer-account.order-status.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {})
  );
  function Extension() {
    const order = useOrder();
    const [customerName, setCustomerName] = (0, import_react11.useState)("");
    ...
    (0, import_react11.useEffect)(() => {
      ...
      ).then((response) => response.json()).then(({ data: { customer: { firstName } } }) => {
        setCustomerName(firstName);
      }).catch(console.error);
    });
    console.log("customerName", customerName);
    if (order) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { children: [
...
//# sourceMappingURL=order-pdf-generator-ui.js.map
